...
if($crop=="rice"){
    ...
    echo "<div class='input-group-prepend'>";
        ...
        echo "<select class='form-control' id='crop2' >";
        	echo "<option selected='true' value='none' disabled='disabled'>--Select--</option>";                                  
            $res_id=0; 
            ...
            if($variety=="all"){        
        		...
        		$result = mysqli_query($con,"select * from crop where date_added between '$date_start' and '$end_date' and data_status='current' and user_id='$res_id' and crop='rice' and variety!='NSIC Rc9' and variety!='NSIC Rc14' and variety!='PSB Rc18' and variety!='$variety';");
        	}
    ...
    echo "<button  class='btn btn-primary' onclick=cost_of_production('rice')>Export CSV</button>";  
    echo "</div>";
    echo "</div>";
    echo "</div>";
    echo "</div>";
    ...
    echo "</div>";
    echo "<div class='col-md-1'>";
    echo "<button  class='btn btn-primary' onclick=cost_of_production('onion')>Export CSV</button>";  
    echo "</div>";
    echo "</div>";
    echo "</div>";
    echo "<br><br>";
