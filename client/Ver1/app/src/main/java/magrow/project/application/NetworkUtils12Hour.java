...
public class NetworkUtils12Hour {

    private static final String TAG = "NetworkUtils";

    private final static String WEATHERDB_BASE_URL=
            "http://dataservice.accuweather.com/forecasts/v1/hourly/12hour/"+ Home.location;

    private final static String API_KEY = "z0cIMXn0h0u6WZfcaQ0hLhd096Ef3nck";
