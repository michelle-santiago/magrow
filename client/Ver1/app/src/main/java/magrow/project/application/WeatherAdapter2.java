...
public class WeatherAdapter2 extends ArrayAdapter<WeatherModel2> {
    public WeatherAdapter2(@NonNull Context context, ArrayList<WeatherModel2> weatherArrayList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        WeatherModel2 weather = getItem(position);
        ...
        String[] date_temp=weather.getDate().split(" ");
        dateTextView.setText(date_temp[0]+" "+date_temp[1]+"\n"+date_temp[2]+" "+date_temp[3]);

        minTextView.setText("Temperature: "+weather.getTemp()+" °C");
