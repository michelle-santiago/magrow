...
<html>
  ...
  <?php }?>
    ...
    <li class="sidebar-list-item"><a href="index.php" class="sidebar-link text-muted"><i class="o-user-details-1 mr-3 text-gray"></i><span>Accounts</span></a></li>
              ...
              <li class="sidebar-list-item"><a href="forms.php" class="sidebar-link text-muted active"><i class="o-archive-folder-1 mr-3 text-gray"></i><span>Records</span></a></li>
...
<li class="sidebar-list-item"><a href="index.php" class="sidebar-link text-muted"><i class="o-home-1 mr-3 text-gray"></i><span>Home</span></a></li>
              ...
              <li class="sidebar-list-item"><a href="forms.php" class="sidebar-link text-muted active"><i class="o-survey-1 mr-3 text-gray"></i><span>Reports</span></a></li>
              <li class="sidebar-list-item"><a href="?logout=1" class="sidebar-link text-muted"><i class="o-exit-1 mr-3 text-gray"></i><span>Logout</span></a></li> 
 ...
 <ul class="nav nav-tabs">
  ...
  <li class="nav-item">
  <a href="#ccc" class="nav-link active" data-toggle="tab">Records</a>
  </li>
  <li class="nav-item">
...
<div class="tab-content" id="tabs">
    ...
    <div class="tab-pane active" id="ccc">
    
    <div class="row">
               <div class="col-lg-12">
                 <div class="card">
                   <div class="card-header">
                     <h6 class="text-uppercase mb-0" style="color:#01bea2">RECORDS</h6>
                   </div>
                   <div class="card-body">   
    ...
    <div class="row">
               <div class="col-lg-12">
                 <div class="card">
                   <div class="card-header">
                     <h6 class="text-uppercase mb-0" style="color:#01bea2">EVENTS</h6>
                   </div>
                   <div class="card-body">   
   ...
   else if($_SESSION['username']!="rell"&&$_SESSION['username']!="rell.chui@gmail.com"&&$_SESSION['username']!="teal"&&$_SESSION['username']!="achhhoooo@gmail.com") {?>
       <div class="col-lg-12">
                <div class="card">
                  <div class="card-header">
                    <h3 class="h6 text-uppercase mb-0">Crop Production and its cost</h3>
                  </div>
                  <div class="card-body">
                      <ul class="nav nav-pills">
                        ...
                        <div class="tab-pane active" id="rice2">
                            ...
                            <div class="col-md-1">
                                  <button  class="btn btn-success" onclick="showListExport('rice')">Filter</button>  
                            </div>
                        </div><br>
                      ...
                      <div class="tab-pane" id="onion2">
                            ...
                            <div class="col-md-1">
                                  <button  class="btn btn-success" onclick="showListExport('onion')">Filter</button>  
                            </div>
                          </div><br>
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-6 text-center text-md-left text-primary">
                <p class="mb-2 mb-md-0">MAGROW &copy; 2018-2020</p>
              </div>
...
$(document).ready(function() {
  $('#table_container1').DataTable({stateSave: true});
  $('#table_container2').DataTable({stateSave: true});
    if (location.hash) {
